...
complete -c gg -f -n '! __fish_seen_subcommand_from ls ls-remote install remove use -h --help' -a '-h' -d 'print this help message'
complete -c gg -f -n '! __fish_seen_subcommand_from ls ls-remote install remove use -h --help' -a '--help' -d 'print this help message'
